...
const Navbar = () => {
  ...
  return (
    <div className="flex box-border  justify-between items-center px-4 bg-slate-500 dark:bg-slate-900 h-20 w-full">
      <div className="font-signature text-5xl md:text-4xl font-bold text-white hover:scale-105 duration-200 ">
        O.K
      </div>
      <div className="flex justify-between space-x-3  items-center h-full">
        <div
      ...
      {!nav && (
        <div className="absolute top-20 left-0 h-[calc(100vh-80px)] w-full bg-slate-500 dark:bg-slate-900 ">
